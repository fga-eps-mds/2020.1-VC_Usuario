...
router.put('/postage/delete_one', UPS.check_exist_user_and_postage, Postage.check_postage_is_not_anon, Postage.check_user_of_postage, UPS.delete_UPSs, UPC.delete_UPCs, Postage.delete_one);
