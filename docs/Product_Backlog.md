...
| E3 | FT10 | US18 | Eu, como usuário, posso usar a aplicação somente dentro das dependências da universidade            | 5 |
...
| **Data de Adição** | **Épico** | **Feacture** | **História de Usuário** | **Descrição** | **Pontos** |
| --- | --- | --- | --- | --- | --- |
| 22/09 | E2 | FT02 | US07 | Eu, como usuário logado, desejo realizar uma postagem não anônima                        | 3 |
| 22/09 | E2 | FT03 | US15 | Eu, como usuário, desejo filtrar a lista de postagens por categoria                      | 3 |
| 22/09 | E3 | FT10 | US18 | Eu, como usuário, posso usar a aplicação somente dentro das dependências da universidade | 5 |
